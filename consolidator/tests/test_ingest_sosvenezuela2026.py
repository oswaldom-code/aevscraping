"""
Integración consolidador <- scraper sosvenezuela2026.

Genera un registro con el mapeo REAL del scraper (`map_row`); si su esquema deriva,
el test lo detecta. Lo ingiere por el pipeline del consolidador con un maestro
...
SCRAPER = _load("sos_scraper", "scrapers/sosvenezuela2026/scraper.py")
FUENTE = "sosvenezuela2026"


def sample_record():
    return SCRAPER.map_row({
        "id": "33625a9b-bdeb-4a48-a790-7fd1173c53b5",
        "status": "seeking_info",
        "display_name": "Carlos Montilla",
        "parroquia": "La Guaira · Catia La Mar",
        "photo_path": "https://example/foto",
        "source_date": "2026-06-29T12:00:00.000Z",
    })


class TestIngestSosvenezuela2026(unittest.TestCase):
    def setUp(self):
